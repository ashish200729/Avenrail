...
/**
 * Translate a Codex app-server notification into Avenrail HarnessEvents.
...
/** Codex thread items Avenrail already renders elsewhere or that are internal metadata. */
